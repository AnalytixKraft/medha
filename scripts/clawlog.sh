...
show_usage() {
    cat << EOF
clawlog - Medha Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View Medha logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    Medha logs flow through the macOS unified log (subsystem: ai.medha).
