...
# Output:
# - dist/Medha.app
# - dist/Medha-<version>.zip
# - dist/Medha-<version>.dmg
...
ZIP="$ROOT_DIR/dist/Medha-$VERSION.zip"
DMG="$ROOT_DIR/dist/Medha-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/Medha-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/Medha-$VERSION.dSYM.zip"
