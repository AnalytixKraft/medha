...
- Keep product names in English: Medha, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the Medha Gateway, use “Gateway 网关”.
