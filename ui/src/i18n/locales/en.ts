...
export const en: TranslationMap = {
  ...
  subtitles: {
    ...
    pairing: "Manually manage paired contacts and revoke access.",
    email: "Connect mail providers, preview inbox messages, and draft-confirm outbound send.",
