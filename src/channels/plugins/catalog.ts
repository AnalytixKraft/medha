...
import { discoverMedhaPlugins } from "../../plugins/discovery.js";
import type { MedhaPackageManifest } from "../../plugins/manifest.js";
...
type ExternalCatalogEntry = {
  ...
  version?: string;
  description?: string;
} & Partial<Record<ManifestKey, MedhaPackageManifest>>;
...
const ENV_CATALOG_PATHS = ["MEDHA_PLUGIN_CATALOG_PATHS", "MEDHA_MPM_CATALOG_PATHS"];
...
function toChannelMeta(params: {
  channel: NonNullable<MedhaPackageManifest["channel"]>;
  id: string;
}): ChannelMeta | null {
...
function buildCatalogEntry(candidate: {
  ...
  packageDir?: string;
  workspaceDir?: string;
  packageManifest?: MedhaPackageManifest;
...
export function listChannelPluginCatalogEntries(
  ...
  const discovery = discoverMedhaPlugins({ workspaceDir: options.workspaceDir });
