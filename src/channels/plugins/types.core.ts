...
export type ChannelAgentToolFactory = (params: { cfg?: MedhaConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: MedhaConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: MedhaConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: MedhaConfig }) => boolean;
  supportsCards?: (params: { cfg: MedhaConfig }) => boolean;
