...
export function listChannelMessageActions(cfg: MedhaConfig): ChannelMessageActionName[] {
...
export function supportsChannelMessageButtons(cfg: MedhaConfig): boolean {
  for (const plugin of listChannelPlugins()) {
...
export function supportsChannelMessageCards(cfg: MedhaConfig): boolean {
  for (const plugin of listChannelPlugins()) {
