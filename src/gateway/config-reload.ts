...
import type { MedhaConfig, ConfigFileSnapshot, GatewayReloadMode } from "../config/config.js";
...
export function resolveGatewayReloadSettings(cfg: MedhaConfig): GatewayReloadSettings {
...
export function startGatewayConfigReloader(opts: {
  initialConfig: MedhaConfig;
  readSnapshot: () => Promise<ConfigFileSnapshot>;
  onHotReload: (plan: GatewayReloadPlan, nextConfig: MedhaConfig) => Promise<void>;
  onRestart: (plan: GatewayReloadPlan, nextConfig: MedhaConfig) => void;
  log: {
