...
import { type MedhaConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: MedhaConfig): string[] {
...
export function listAgentsForGateway(cfg: MedhaConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: MedhaConfig): string {
...
function resolveSessionStoreAgentId(cfg: MedhaConfig, canonicalKey: string): string {
...
export function loadCombinedSessionStoreForGateway(cfg: MedhaConfig): {
  storePath: string;
  store: Record<string, SessionEntry>;
} {
...
export function getSessionDefaults(cfg: MedhaConfig): GatewaySessionsDefaults {
