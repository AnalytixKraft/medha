...
beforeAll(async () => {
  previousToken = process.env.MEDHA_GATEWAY_TOKEN;
  process.env.MEDHA_GATEWAY_TOKEN = "test-gateway-token-1234567890";
...
test.each([
  { clientId: "medha-ios", platform: "ios" },
  { clientId: "medha-android", platform: "android" },
