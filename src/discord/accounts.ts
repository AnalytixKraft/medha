...
function mergeDiscordAccountConfig(cfg: MedhaConfig, accountId: string): DiscordAccountConfig {
...
export function listEnabledDiscordAccounts(cfg: MedhaConfig): ResolvedDiscordAccount[] {
