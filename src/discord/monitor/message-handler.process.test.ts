...
const resolveStorePath = vi.fn(() => "/tmp/medha-discord-process-test-sessions.json");
...
beforeEach(() => {
  ...
  resolveStorePath.mockReturnValue("/tmp/medha-discord-process-test-sessions.json");
});
