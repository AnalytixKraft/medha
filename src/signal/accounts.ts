...
function mergeSignalAccountConfig(cfg: MedhaConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: MedhaConfig): ResolvedSignalAccount[] {
