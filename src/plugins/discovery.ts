...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @medha/voice-call -> voice-call).
...
export function discoverMedhaPlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ...
  if (workspaceDir) {
    ...
    const workspaceExtDirs = [path.join(workspaceRoot, ".medha", "extensions")];
