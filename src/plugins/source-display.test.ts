...
describe("formatPluginSourceForTable", () => {
  it("shortens bundled plugin sources under the stock root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "bundled",
        source: "/opt/homebrew/lib/node_modules/medha/extensions/bluebubbles/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/medha/extensions",
        global: "/Users/x/.medha/extensions",
        workspace: "/Users/x/ws/.medha/extensions",
      },
    );
  ...
  it("shortens workspace plugin sources under the workspace root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "workspace",
        source: "/Users/x/ws/.medha/extensions/matrix/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/medha/extensions",
        global: "/Users/x/.medha/extensions",
  ...
  it("shortens global plugin sources under the global root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "global",
        source: "/Users/x/.medha/extensions/zalo/index.js",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/medha/extensions",
        global: "/Users/x/.medha/extensions",
