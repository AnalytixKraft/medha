...
describe("tts", () => {
  ...
  describe("maybeApplyTtsToPayload", () => {
    ...
    const withMockedAutoTtsFetch = async (
      ...
      const prevPrefs = process.env.MEDHA_TTS_PREFS;
      process.env.MEDHA_TTS_PREFS = `/tmp/tts-test-${Date.now()}.json`;
      ...
      try {
        ...
        process.env.MEDHA_TTS_PREFS = prevPrefs;
      }
    };

    const taggedCfg: MedhaConfig = {
      ...baseCfg,
      messages: {
        ...baseCfg.messages!,
