...
function resolveGatewayPort(cfg: MedhaConfig, env: NodeJS.ProcessEnv): number {
...
function resolveAuth(cfg: MedhaConfig, env: NodeJS.ProcessEnv): ResolveAuthResult {
  ...
  const password =
    env.MEDHA_GATEWAY_PASSWORD?.trim() ||
