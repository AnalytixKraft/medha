...
describe("writeOAuthCredentials", () => {
  ...
  it("writes auth-profiles.json under MEDHA_AGENT_DIR when set", async () => {
    const env = await setupAuthTestEnv("medha-oauth-");
...
describe("setMinimaxApiKey", () => {
  ...
  it("writes to MEDHA_AGENT_DIR when set", async () => {
    const env = await setupAuthTestEnv("medha-minimax-", { agentSubdir: "custom-agent" });
    lifecycle.setStateDir(env.stateDir);
