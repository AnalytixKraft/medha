...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.medha.ai/automation/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("medha hooks list")}`,
      `  ${formatCliCommand("medha hooks enable <name>")}`,
      `  ${formatCliCommand("medha hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
