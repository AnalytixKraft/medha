...
function resolveDefaultAccountId(cfg: MedhaConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: MedhaConfig): boolean {
...
export function summarizeBindings(cfg: MedhaConfig, bindings: AgentBinding[]): string[] {
