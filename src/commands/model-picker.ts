...
type PromptDefaultModelResult = { model?: string; config?: MedhaConfig };
...
function resolveConfiguredModelRaw(cfg: MedhaConfig): string {
...
function resolveConfiguredModelKeys(cfg: MedhaConfig): string[] {
...
export function applyPrimaryModel(cfg: MedhaConfig, model: string): MedhaConfig {
...
export function applyModelAllowlist(cfg: MedhaConfig, models: string[]): MedhaConfig {
  const defaults = cfg.agents?.defaults;
