    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["medha channels list", "List configured channels and auth profiles."],
          ["medha channels status --probe", "Run channel status checks and probes."],
          [
            "medha channels add --channel telegram --token <token>",
            "Add or update a channel account non-interactively.",
          ],
          ["medha channels login --channel whatsapp", "Link a WhatsApp Web account."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/channels",
          "docs.medha.ai/cli/channels",
        )}\n`,
    );
