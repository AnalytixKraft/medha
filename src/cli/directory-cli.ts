    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["medha directory self --channel slack", "Show the connected account identity."],
          [
            'medha directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["medha directory groups list --channel discord", "List available groups/channels."],
          [
            "medha directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.medha.ai/cli/directory",
        )}\n`,
    )
    .action(() => {
