...
export const A2UI_PATH = "/__medha__/a2ui";

export const CANVAS_HOST_PATH = "/__medha__/canvas";

export const CANVAS_WS_PATH = "/__medha__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.medhaCanvasA2UIAction.postMessage(...)
  // - Android: window.medhaCanvasA2UIAction.postMessage(...)
  const handlerNames = ["medhaCanvasA2UIAction"];
  ...
  globalThis.Medha = globalThis.Medha ?? {};
  globalThis.Medha.postMessage = postToNode;
  globalThis.Medha.sendUserAction = sendUserAction;
  globalThis.medhaPostMessage = postToNode;
  globalThis.medhaSendUserAction = sendUserAction;
