...
import type { MedhaPluginApi } from "../plugins/types.js";
...
function resolveHookDir(api: MedhaPluginApi, dir: string): string {
...
function normalizePluginHookEntry(api: MedhaPluginApi, entry: HookEntry): HookEntry {
  return {
    ...entry,
    hook: {
      ...entry.hook,
