...
export type { MedhaConfig } from "../config/config.js";
/** @deprecated Use MedhaConfig instead */
export type { MedhaConfig as ClawdbotConfig } from "../config/config.js";
