...
function mergeIMessageAccountConfig(cfg: MedhaConfig, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: MedhaConfig): ResolvedIMessageAccount[] {
