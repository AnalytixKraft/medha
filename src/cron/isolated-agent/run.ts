...
export type RunCronAgentTurnResult = {
   ...
   * messages.  See: https://github.com/medha/medha/issues/15692
   */
  delivered?: boolean;
} & CronRunOutcome &
  CronRunTelemetry;
...
export async function runCronIsolatedAgentTurn(params: {
  ...
  const isFastTestEnv = process.env.MEDHA_TEST_FAST === "1";
  ...
  // correct per-agent paths (e.g. ~/.medha/agents/<agentId>/agent/).
  ...
  const cfgWithAgentDefaults: MedhaConfig = {
    ...params.cfg,
