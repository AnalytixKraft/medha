...
export function listWhatsAppAuthDirs(cfg: MedhaConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: MedhaConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: MedhaConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: MedhaConfig): ResolvedWhatsAppAccount[] {
