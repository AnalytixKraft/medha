...
function mergeSlackAccountConfig(cfg: MedhaConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: MedhaConfig): ResolvedSlackAccount[] {
