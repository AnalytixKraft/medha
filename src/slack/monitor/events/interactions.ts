...
// Prefix for Medha-generated action IDs to scope our handler
const MEDHA_ACTION_PREFIX = "medha:";
...
export function registerSlackInteractionEvents(params: { ctx: SlackMonitorContext }) {
  ...
  // Handle Medha modal submissions with callback_ids scoped by our prefix.
  ctx.app.view(
    new RegExp(`^${MEDHA_ACTION_PREFIX}`),
