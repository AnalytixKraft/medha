...
function isTelegramConfigured(cfg: MedhaConfig, env: NodeJS.ProcessEnv): boolean {
...
function isDiscordConfigured(cfg: MedhaConfig, env: NodeJS.ProcessEnv): boolean {
...
function isIrcConfigured(cfg: MedhaConfig, env: NodeJS.ProcessEnv): boolean {
...
function isSlackConfigured(cfg: MedhaConfig, env: NodeJS.ProcessEnv): boolean {
  if (
...
function isSignalConfigured(cfg: MedhaConfig): boolean {
...
function isIMessageConfigured(cfg: MedhaConfig): boolean {
...
function isWhatsAppConfigured(cfg: MedhaConfig): boolean {
...
function isGenericChannelConfigured(cfg: MedhaConfig, channelId: string): boolean {
...
function collectModelRefs(cfg: MedhaConfig): string[] {
  const refs: string[] = [];
...
function isProviderConfigured(cfg: MedhaConfig, providerId: string): boolean {
...
function isPluginExplicitlyDisabled(cfg: MedhaConfig, pluginId: string): boolean {
  const entry = cfg.plugins?.entries?.[pluginId];
  return entry?.enabled === false;
}

function isPluginDenied(cfg: MedhaConfig, pluginId: string): boolean {
...
function registerPluginEntry(cfg: MedhaConfig, pluginId: string): MedhaConfig {
  const entries = {
    ...cfg.plugins?.entries,
    [pluginId]: {
