...
function resolveAnthropicDefaultAuthMode(cfg: MedhaConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: MedhaConfig): MedhaConfig {
...
export function applyTalkApiKey(config: MedhaConfig): MedhaConfig {
...
export function applyModelDefaults(cfg: MedhaConfig): MedhaConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: MedhaConfig): MedhaConfig {
...
export function applyLoggingDefaults(cfg: MedhaConfig): MedhaConfig {
...
export function applyContextPruningDefaults(cfg: MedhaConfig): MedhaConfig {
...
export function applyCompactionDefaults(cfg: MedhaConfig): MedhaConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
