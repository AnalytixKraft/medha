...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "tools.email": "Email Tool",
  "tools.email.provider": "Email Provider",
  "tools.email.smtp": "SMTP",
  "tools.email.from": "Sender",
  "tools.email.enabled": "Enable Send Email Tool",
  "tools.email.smtp.host": "SMTP Host",
  "tools.email.smtp.port": "SMTP Port",
  "tools.email.smtp.secure": "SMTP Secure (TLS)",
  "tools.email.smtp.username": "SMTP Username",
  "tools.email.smtp.password": "SMTP Password",
  "tools.email.smtp.rejectUnauthorized": "SMTP TLS Verify Cert",
  "tools.email.from.address": "Email From Address",
  "tools.email.from.name": "Email From Name",
  "tools.email.from.replyTo": "Email Reply-To",
  "tools.email.timeoutSeconds": "Email Timeout (sec)",
