...
export const DEFAULT_SANDBOX_IMAGE = "medha-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "medha-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "medha-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "medha-sandbox-common:bookworm-slim";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "medha-sbx-browser-";
