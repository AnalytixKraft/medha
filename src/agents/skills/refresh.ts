...
function resolveWatchPaths(workspaceDir: string, config?: MedhaConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: MedhaConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: MedhaConfig }) {
