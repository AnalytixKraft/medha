...
function makeCfg(overrides: Partial<MedhaConfig> = {}): MedhaConfig {
  return {
    agents: {
      defaults: {
        model: {
...
function makeFallbacksOnlyCfg(): MedhaConfig {
  return {
    agents: {
      defaults: {
        model: {
...
function makeProviderFallbackCfg(provider: string): MedhaConfig {
  return makeCfg({
    agents: {
      defaults: {
        model: {
