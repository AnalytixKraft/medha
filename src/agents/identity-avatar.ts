...
function resolveAvatarSource(cfg: MedhaConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: MedhaConfig, agentId: string): AgentAvatarResolution {
