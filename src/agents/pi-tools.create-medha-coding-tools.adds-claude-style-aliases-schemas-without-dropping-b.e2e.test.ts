...
describe("createMedhaCodingTools", () => {
  ...
  it("gates apply_patch behind tools.exec.applyPatch for OpenAI models", () => {
    ...
    const openAiTools = createMedhaCodingTools({
      config,
    ...
    const anthropicTools = createMedhaCodingTools({
      config,
  ...
  it("respects apply_patch allowModels", () => {
    ...
    const allowed = createMedhaCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5.2",
    });
    ...
    const denied = createMedhaCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
