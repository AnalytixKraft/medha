...
function resolveAdaptiveReadMaxBytes(options?: MedhaReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createMedhaReadTool(base, {
...
export function createMedhaReadTool(
  base: AnyAgentTool,
  options?: MedhaReadToolOptions,
): AnyAgentTool {
