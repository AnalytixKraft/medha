...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof MedhaConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: MedhaConfig; env: NodeJS.ProcessEnv }): {
  cfg: MedhaConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
