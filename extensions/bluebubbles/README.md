...
This directory contains the **BlueBubbles external channel plugin** for Medha.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `medha/plugin-sdk` helpers.
