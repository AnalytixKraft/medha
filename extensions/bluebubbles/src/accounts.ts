...
export function listBlueBubblesAccountIds(cfg: MedhaConfig): string[] {
...
export function resolveDefaultBlueBubblesAccountId(cfg: MedhaConfig): string {
...
export function listEnabledBlueBubblesAccounts(cfg: MedhaConfig): ResolvedBlueBubblesAccount[] {
