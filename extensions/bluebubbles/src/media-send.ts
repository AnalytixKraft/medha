...
import { resolveChannelMediaMaxBytes, type MedhaConfig } from "medha/plugin-sdk";
...
function resolveMediaLocalRoots(params: { cfg: MedhaConfig; accountId?: string }): string[] {
