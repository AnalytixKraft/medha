...
export function listMattermostAccountIds(cfg: MedhaConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: MedhaConfig): string {
...
export function listEnabledMattermostAccounts(cfg: MedhaConfig): ResolvedMattermostAccount[] {
