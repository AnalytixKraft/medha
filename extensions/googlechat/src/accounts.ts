...
export function listGoogleChatAccountIds(cfg: MedhaConfig): string[] {
...
export function resolveDefaultGoogleChatAccountId(cfg: MedhaConfig): string {
...
export function listEnabledGoogleChatAccounts(cfg: MedhaConfig): ResolvedGoogleChatAccount[] {
