...
import type { ReplyPayload, MedhaConfig } from "medha/plugin-sdk";
import { createReplyPrefixOptions } from "medha/plugin-sdk";
...
async function processTwitchMessage(params: {
  ...
  const cfg = config as MedhaConfig;
