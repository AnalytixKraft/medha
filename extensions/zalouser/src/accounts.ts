...
export function listZalouserAccountIds(cfg: MedhaConfig): string[] {
...
export function resolveDefaultZalouserAccountId(cfg: MedhaConfig): string {
...
function mergeZalouserAccountConfig(cfg: MedhaConfig, accountId: string): ZalouserAccountConfig {
