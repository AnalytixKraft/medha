...
Nostr DM channel plugin for Medha using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to Medha. It enables your bot to:
...
```bash
medha plugins install @medha/nostr
```
...
# Configure medha to use local relay
