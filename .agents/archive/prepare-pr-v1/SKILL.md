...
- `fix: <summary> (medha#<PR>) thanks @<author>`

```sh
commit_msg="fix: <summary> (medha#$pr_number) thanks @$contrib"
...
echo "$subject" | rg -q "medha#$pr_number" || { echo "ERROR: commit subject missing medha#$pr_number"; exit 1; }
